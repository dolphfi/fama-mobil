...
const MainLayout = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-background font-sans antialiased">
            ...
            <header className="bg-gradient-to-r from-[#0071ce] to-[#0047D1] text-white shadow-md">
                <div className="container mx-auto px-4">
                    {/* Top Bar - Rakuten/eBay inspired */}
                    <div className="flex items-center justify-between py-2 text-xs border-b border-white/20">
                    ...
                    <div className="flex items-center gap-6 py-3">
                        ...
                        {/* Search Bar - eBay/Rakuten style with category */}
                        <form onSubmit={handleSearch} className="flex-1 max-w-4xl">
                            <div className="flex bg-white rounded-lg overflow-hidden shadow-sm">
                                <input
                                    ...
                                    placeholder="Search for medical supplies, medicines, equipment..."
                                    className="flex-1 px-4 py-3 text-gray-900 focus:outline-none text-sm"
                                />
                                <select className="px-3 py-3 text-gray-700 border-l text-sm bg-gray-50 hover:bg-gray-100 cursor-pointer focus:outline-none">
                                ...
                                <button
                                    type="submit"
                                    className="bg-[#0A9D0E] hover:bg-[#088a0c] px-6 transition-colors flex items-center justify-center"
                                >
                        ...
                        {/* Right Icons - eBay/Rakuten inspired */}
                        <div className="flex items-center gap-4">
                            <Link to="/wishlist" className="flex flex-col items-center hover:opacity-80 transition-opacity">
                            ...
                            <Link to="/orders" className="flex flex-col items-center hover:opacity-80 transition-opacity">
